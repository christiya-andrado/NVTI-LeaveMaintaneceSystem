            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-lg-5">
                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="developers-guide.php">Guidance</a>
                        </li>
                        ...
                        <div class="col-lg-7 col-12">
                            <div class="hero-text">
                                <div class="hero-title-wrap d-flex align-items-center mb-4">
                                    <img src="images1/pic1.jpg" class="avatar-image avatar-image-large img-fluid" alt="">
                        ...
                        <div class="col-lg-6 col-12 mt-5 mt-lg-0">
                            <div class="about-thumb">
                                ...
                                <div class="section-title-wrap d-flex justify-content-end align-items-center mb-4">
                                    <h2 class="text-white me-4 mb-0">Christiya</h2>
                                    

                                    <img src="images1/pic1.jpg" class="avatar-image img-fluid" alt="">
                                </div>

                                <h3 class="pt-2 mb-3">Developer</h3>
                                <h5 class="pt-2 mb-3">Completed NDICT NVQ L-5</h5>

                                <p>Christiya is a highly skilled individual with a talent for web development,
                                     demonstrating a remarkable ability to handle complex tasks in web programming.</p>
                                <p>She is a talented web developer, offered full support and 
                                    demonstrated exceptional ability in handling complex tasks for this project.</p>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="profile-thumb">
                                <div class="profile-title">
                                    <h4 class="mb-0">Info of Developer</h4>
                                </div>
                                ...
                                <div class="profile-body">
                                    ...
                                    <p>
                                        <span class="profile-small-title">Diploma in </span> 
                                        <span>NDICT</span>
                                    </p>

                                    <p>
                                        <span class="profile-small-title">Phone</span> 
                                         <span><a href="tel: 077-608-2420">075-824-4426</a></span>
                                    </p>

                                    <p>
                                        <span class="profile-small-title">Email</span> 
                                        <span><a href="mailto:christiyachris@gmail.com">christiyachris@gmail.com</a></span>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-6 col-12 ps-lg-0">
                                <div class="contact-info d-flex flex-column">
                                    ...
                                    <p>
                                        <a href="mailto:christiyachris@gmail.com">
                                        christiyachris@gmail.com
                                        </a>
                                    </p>
