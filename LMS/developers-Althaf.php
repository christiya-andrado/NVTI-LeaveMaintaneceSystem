                        ...
                        <div class="col-lg-7 col-12">
                            <div class="hero-text">
                                <div class="hero-title-wrap d-flex align-items-center mb-4">
                                    <img src="images1/alf.jpg" class="avatar-image avatar-image-large img-fluid" alt="">
                        ...
                        <div class="col-lg-6 col-12 mt-5 mt-lg-0">
                            <div class="about-thumb">
                                ...
                                <div class="section-title-wrap d-flex justify-content-end align-items-center mb-4">
                                    <h2 class="text-white me-4 mb-0">Althaf</h2>
                                    

                                    <img src="images1/alf.jpg" class="avatar-image img-fluid" alt="">
                                </div>

                                <h3 class="pt-2 mb-3">Developer</h3>
                                <h5 class="pt-2 mb-3">Completed NDICT NVQ L-5</h5>

                                <p>Althaf possesses exceptional web design skills and exhibits a remarkable creative 
                                 flair for outstanding web development.</p>
                                <p>This project exemplifies Althaf's exceptional UI design talents and 
                                    adeptness in effectively managing and handling tasks.</p>
                                ...
                                <div class="profile-body">
                                    ...
                                    <p>
                                        <span class="profile-small-title">Phone</span> 
                                         <span><a href="tel: 077-608-2420">075-661-9154</a></span>
                                    </p>

                                    <p>
                                        <span class="profile-small-title">Email</span> 
                                        <span><a href="mailto:althaalf224@gmail.com">althaalf224@gmail.com</a></span>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-6 col-12 ps-lg-0">
                                <div class="contact-info d-flex flex-column">
                                    ...
                                    <p>
                                        <a href="mailto:althafalf224@gmail.com">
                                        althafalf224@gmail.com
                                        </a>
                                    </p>
