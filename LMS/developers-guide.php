...
<html lang="en">
    <head>
        ...
        <title>Developers-Guidance</title>
        ...
        <link href="css/templatemo-first-portfolio-style1.css" rel="stylesheet">
        <style>
        .bts{
            background:#9d1d40; 
            color:#fff; 
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                ...
                <ul class="navbar-nav ms-lg-5">
                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="#">Guidance</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link " href="developers-Abdur.php">Abdur Rahman</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link " href="developers-Christiya.php">Christiya</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link " href="developers-Asfara.php">Asfara</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="developers-Althaf.php">Althaf</a>
                        </li>
                    </ul>
                     ...
                     <a class="btn bts" style=" " href="index.php">Back</a>
        ...
        <main>
            ...
            <section class="hero d-flex justify-content-center align-items-center" >
                        ...
                        <div class="col-lg-7 col-12">
                            <div class="hero-text">
                                <div class="hero-title-wrap d-flex align-items-center mb-4">
                                    <img src="images1/avatar/sukry.jpg" class="avatar-image avatar-image-large img-fluid" alt="">

                                    <h1 class="hero-title ms-3 mb-0">Hello friend!</h1>
                                </div>

                                <h2 class="mb-4">How was our Guidance..?</h2>
                                <p class="mb-4"><a class="custom-btn btn custom-link" href="#section_5">Let's Comment</a></p>
                            </div>
                        </div>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#1ecbe1" fill-opacity="1" d="M0,160L24,160C48,160,96,160,144,138.7C192,117,240,75,288,64C336,53,384,75,432,106.7C480,139,528,181,576,208C624,235,672,245,720,240C768,235,816,213,864,186.7C912,160,960,128,1008,133.3C1056,139,1104,181,1152,202.7C1200,224,1248,224,1296,197.3C1344,171,1392,117,1416,90.7L1440,64L1440,0L1416,0C1392,0,1344,0,1296,0C1248,0,1200,0,1152,0C1104,0,1056,0,1008,0C960,0,912,0,864,0C816,0,768,0,720,0C672,0,624,0,576,0C528,0,480,0,432,0C384,0,336,0,288,0C240,0,192,0,144,0C96,0,48,0,24,0L0,0Z"></path></svg>
            </section>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <img src="images1/avatar/252-2520889_man-with-laptop-png-laptop.PNG" class="about-image img-fluid" alt="">
                        </div>
                        ...
                        <div class="col-lg-6 col-12 mt-5 mt-lg-0">
                            <div class="about-thumb">
                                ...
                                <div class="section-title-wrap d-flex justify-content-end align-items-center mb-4">
                                    <h2 class="text-white me-4 mb-0">Our Instructor</h2>
                                    

                                    <img src="images1/avatar/sukry.jpg" class="avatar-image img-fluid" alt="">
                                </div>

                                <h3 class="pt-2 mb-3">Instructor of Vantharumoolai NVTI</h3>
                                <h5 class="pt-2 mb-3">NDICT NVQ L-5</h5>

                                <p>Our sir gave us complete cooperation at the time of need and was more and more supportive till the system was completed to incorporate more techniques...</p>
                                <p>This helped us to complete all the necessary techniques and complete requirements from start to finish of our project.</p>
...
<div class="col-lg-6 col-12 mt-5 mt-lg-0">
    <div class="about-thumb">
        ...
        <div class="section-title-wrap d-flex justify-content-end align-items-center mb-4">
            <h2 class="text-white me-4 mb-0">Our Instructress</h2>
            

            <img src="images1/avatar/miss.jpg" class="avatar-image img-fluid" alt="">
        </div>

        <h3 class="pt-2 mb-3">Instructor of Vantharumoolai NVTI</h3>
        <h5 class="pt-2 mb-3">NDICT NVQ L-5</h5>

        <p>Our miss gave us complete cooperation at the time of need and was more and more supportive till the system was completed to incorporate more techniques...</p>
        <p>This helped us to complete all the necessary techniques and complete requirements from start to finish of our project.</p>
...
<div class="col-lg-6 col-12">
    <img src="images1/avatar/miss.jpg" class="about-image img-fluid" alt="">
</div>
            ...
            <section class="featured section-padding">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="profile-thumb">
                                <div class="profile-title">
                                    <h4 class="mb-0">Info of Our Instructor</h4>
                                </div>

                                <div class="profile-body">
                                    <p>
                                        <span class="profile-small-title">Name</span> 
                                        <span>M.M.Mohamed Sukry</span>
                                    </p>

                                    <p>
                                        <span class="profile-small-title">Birthday</span> 
                                        <span>Jul 20, 1974</span>
                                    </p>

                                    <p>
                                        <span class="profile-small-title">Phone</span> 
                                         <span><a href="tel: 077-608-2420">077-608-2420</a></span>
                                    </p>

                                    <p>
                                        <span class="profile-small-title">Email</span> 
                                        <span><a href="mailto:sukry119@yahoo.com">sukry119@yahoo.com</a></span>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="profile-thumb">
                                <div class="profile-title">
                                    <h4 class="mb-0">Info of Our Instructress</h4>
                                </div>

                                <div class="profile-body">
                                    <p>
                                        <span class="profile-small-title">Name</span> 
                                        <span>Yasotha Satheeskumar</span>
                                    </p>

                                    <p>
                                        <span class="profile-small-title">Birthday</span> 
                                        <span>Jun 12, 1991</span>
                                    </p>

                                    <p>
                                        <span class="profile-small-title">Phone</span> 
                                         <span><a href="tel:075-386-2630">075-386-2630</a></span>
                                    </p>

                                    <p>
                                        <span class="profile-small-title">Email</span> 
                                        <span><a href="mailto:yasotha196@gmail.com">yasotha196@gmail.com</a></span>
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-12 mx-auto">
                            <div class="section-title-wrap d-flex justify-content-center align-items-center mb-5">
                                ...
                                <h2 class="text-white ms-4 mb-0">Introduction</h2>
                            </div>
            ...
            <div class="galary">
                <div class="galary-item">
                    <img src="images1/slide/vta-1.jpg" alt="">
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-8 col-12">
                                <div class="section-title-wrap d-flex justify-content-center align-items-center mb-5">
                                    ...
                                    <h2 class="text-white ms-4 mb-0">Let's Comment</h2>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-12 pe-lg-0">
                                <div class="contact-info contact-info-border-start d-flex flex-column">
                                    ...
                                    <ul class="social-icon">
                                        <li class="social-icon-item"><a href="https://twitter.com/minthu" class="social-icon-link bi-whatsapp"></a></li>

                                        <li class="social-icon-item"><a href="https://www.linkedin.com/in/mohamed-sukry-687b0a2b" class="social-icon-link bi-linkedin"></a></li>
                                    ...
                                    <p class="mb-0">Our students are available for your valuable projects...</p>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-12 ps-lg-0">
                                <div class="contact-info d-flex flex-column">
                                    ...
                                    <p>
                                        <a href="mailto:sukry119@yahoo.com">
                                        sukry119@yahoo.com
                                        </a>
                                    </p>
...
try {
    ...
    if(isset($_POST['b1']))
    {
        ...
        $msg=$_POST['message'];
    $mail->setFrom($email);
    $mail->addAddress('nvtileave@gmail.com');     // Add a recipient
    $mail->addReplyTo($email, $name);   // Add a reply-to address based on the form submission

    //Content
    $mail->isHTML(true);                                  // Set email format to HTML
    $mail->Subject = 'Feedback' . $name;   // Use the form submitter's name in the email subject
    $mail->Body    = 'Feedback message: ' . $msg;  // Use the form submission as the email message
...
?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-12">
                        <div class="copyright-text-wrap">
                            <p class="mb-0">
                                <span class="copyright-text">Copyright © 2022 <a href="#">NVTI-Batticaloa</a>  All rights reserved.</span>
                            </p>
                        </div>
                    </div>
        ...
        <script src="js/jquery1.sticky.js"></script>
        <script src="js/click-scroll1.js"></script>
        <script src="js/jquery1.magnific-popup.min.js"></script>
