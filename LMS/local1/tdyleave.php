...
<html lang="en">
  <head>
    ...
    <title>Approved Leave Details</title>
...
<?php
   ...
   echo ' <table class="table table-hover">
    ...
    $sql = "SELECT CenterLocation ,COUNT(Empid) FROM employee GROUP BY CenterLocation";
    ...
    if($res)
  {
    ...
    while($row=mysqli_fetch_assoc($res))
    {
      ...
      $totemp=$row['COUNT(Empid)'];
      $sql1 = "SELECT COUNT(l.Empid) FROM leave_details AS l INNER JOIN employee AS e ON l.Empid=e.Empid WHERE Status=1 AND CURDATE() BETWEEN l.FromDate AND l.ToDate GROUP BY e.CenterLocation";
