  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <label class="outline-secondary" style="margin-bottom: 35px;">Edit NoPay </label> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
        &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
        <label class="toggle">
          <?php 
          $sqli="SELECT Remark,nopay,nopay_days FROM `leave_details`WHERE LD_Id=$id";
        ...
        <input type="text" placeholder="Remark" value="<?php echo $r; ?>" name="remark1"> <br>
        <label for="">No of Nopay Days</label> <br>
        <input type="text" placeholder="No of Nopay Days" value="<?php echo $noday; ?>" name="noday">
      </div>
...
<?php
    ...
    $act=new model_cls();
    $set=$act->nopay($rem,$day);
   
    echo '<script> alert ("Successfuly Applied.....!") </script>';
  }
    //$display=display();
