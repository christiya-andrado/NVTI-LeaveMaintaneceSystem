...
if (isset($_SESSION['pin'])) 
{
    ...
    if(isset($_POST['apply']))
    {
        ...
        {
            $sql="INSERT INTO `leave_details`(`Empid`,`FromDate`, `ToDate`, `total_days`, `Reason`, `Acting_Person`, `CL_id`) VALUES ('".$_SESSION['empid']."','$fromdate','$todate', $noofdays, '$leavereason','$acting','$leavetype')";
            ...
            if($res){
                ...
                $mail = new PHPMailer(true);
                        ...
                        try {
                            ...
                            header("Location: verifypin.php?email=" . $eml . "&verification_code=".$verification_code);
                            exit();
                        }
                    }
                        catch (Exception $e) {
