...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
    <h1>Display Admin Level Users</h1>
    <hr>
    ...
    <?php
        ...
        echo ' <table class="table table-hover">    
          <tr   style="background-color: #aa0412d2 ; color: #fff;">
            <th>No</th>
            <th>Name</th>
            <th>User Type</th>
            <th>Operations</th>
        ...
        $sql = "SELECT * FROM manageuser WHERE NOT UserType='O'";
        ...
        $sql1 = "SELECT EmpName FROM employee WHERE P_EPFNo=$epf";

        $resn=mysqli_query($con,$sql1);
        ...
        $name=$rown['EmpName'];
                ...
                if($x%2==1)
                {
                    ...
                    <td>'.$name.'</td>
                    <td>'.$type.'</td>
                    <td> <a href="delete.php?deleteid='.$id.'" class="btn btn-hover btn-danger"> Remove </a> </td> 
                    </tr> </tbody>';
                }
                else
                {
