...
<?php
   ...
   echo ' <table class="table table-hover">
    ...
    INNER JOIN employee AS e ON e.Empid=l.Empid ORDER BY l.LD_Id desc";
    ...
    while($row=mysqli_fetch_assoc($res))
    {
      ...
      if($x%2==1)
      {
        ...
        <tr>
          ...
          if($state=='1')
          {
            echo ' <a href="leaveView.php?id='.$id.'" class="btn btn-secondary"> View </a>';
          }
          elseif($state=='2') {
            echo ' <a href="leaveView1.php?id='.$id.'" class="btn btn-secondary"> View </a>';
          }
          elseif($state=='0'){
            echo ' <a href="leaveView2.php?id='.$id.'" class="btn btn-secondary"> View </a>';
          }
          else{
            echo "Failed...!";
          }
