      ...
      <div class="row" style="padding:10px;">
        <div class="col-md-6 mb-3">
          <div class="card  text-light h-70" style="background-color:#8f1739  ;">
            ...
            <div class="card-heading">
                <div class="row">
                  <div class="col-sm-3"><img src="office-worker.png" alt="" style="margin-left:18px; margin-bottom:18px;"></div>
                  <div class="col-sm-9">
                  <?php 
        ...
        <div class="col-md-6 mb-3">
          <div class="card  text-light h-70" style="background-color:#8f1739  ;">
            ...
            <div class="card-heading">
                <div class="row">
                  <div class="col-sm-3"><img src="comfort-zone.png" alt="" style="margin-left:18px; margin-bottom:18px;"></div>
                  <div class="col-sm-9">
                  <?php
                      ...
                      <tbody>
                          ...
                          <tr>
                            ...
                            <?php
                              if($row3['Status']==1)
                              {
                                echo ' <a href="leaveView.php?id='.$id.'" class="btn btn-success"> View </a>';
                              }
                              elseif($row3['Status']==2) {
                                echo ' <a href="leaveView1.php?id='.$id.'" class="btn btn-danger" style="backraound-opacity:50%;"> View </a>';
                              }
                              else{
                                echo ' <a href="leaveView2.php?id='.$id.'" class="btn btn-primary"> View </a>';
                              }                              
                          }
                          ?>
                          </td>
