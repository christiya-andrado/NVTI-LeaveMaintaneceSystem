...
<html lang="en">
      ...
      <div class="row">
        ...
        <?php
            ...
            <table class="table table-hover">
             ...
             <tr>
              <th colspan="4" style="background-color: #000; color: #fff;">Currently Leave Taken Centres</th>
             </tr>
               <tr>
                 <th>#</th>
                 <th>Centre</th>                
                 <th>No. Of Employees In Duty</th> 
 ...
 <?php
             ...
             $sql = "SELECT * FROM vwcentre_lvdutyinfo";
             ...
             while($row=mysqli_fetch_assoc($res))
             {
               ...
               $lvemp=$row['Employees_On_Duty'];
               $totemp=$row['Total_Employees'];
 ?>              
                             <tbody class="bg-light">
                             <tr>
                             <td> <?php echo $s_no++; ?></td>
                             <td> <?php echo $centre; ?></td>
                             <td> <?php echo $lvemp; ?></td>
        ...
        <div class="row">
            ...
            <table class="table table-hover">
             <thead  style="background-color: #aa0412d2 ; color: #fff;">
             <tr>
              <th colspan="4" style="background-color: #000; color: #fff;">Currently Not Leave Taken Centres</th>
             </tr>
               <tr>
                 <th>#</th>
                 <th>Centre</th>                
 ...
 <?php
             ...
             $sql1 = "SELECT * FROM vwcentre_dutyinfo";
 
             $res1=mysqli_query($con,$sql1);
 
             while($row1=mysqli_fetch_assoc($res1))
             {
               $centre1=$row1['CenterLocation'];
               $lvemp1=$row1['Employees_On_Duty'];
               $totemp1=$row1['Total_Employees'];
 ?>              
                             <tbody class="bg-light">
                             <tr>
                             <td> <?php echo $no++; ?></td>
                             <td> <?php echo $centre1; ?></td>
                             <td> <?php echo $lvemp1; ?></td>
                             <td> <?php echo $totemp1; ?></td>
                             </tr> </tbody>
