...
<?php
   ...
   echo ' <table class="table table-hover">
    ...
    INNER JOIN employee AS e ON e.Empid=l.Empid WHERE l.Status=1 ORDER BY l.LD_Id desc";
    ...
    if($res)
  {
    ...
    while($row=mysqli_fetch_assoc($res))
    {
      ...
      if($state=='1')
        {           
            $apps='<span style="color: green">Approved <img src="check-mark.png"></span>';
        }
      ...
      if($x%2==1)
      {
        ...
        <tr>
          ...
          <td>'.$applied.'</td>
          <td>'.$apps.'</td>
          <td> <a href="leaveview.php?id='.$id.'" class="btn btn-success"> View </a> </td>
        </tr> </tbody>';
      }
      else
      {
