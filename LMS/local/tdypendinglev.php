...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
<br>
<h2>Today Received Leave Applications</h2>
<hr>
...
<?php
   ...
   echo ' <table class="table table-hover">
    ...
    $sql = "SELECT l.LD_Id,e.P_EPFNo,e.C_EPFNo,e.EmpName,c.LeaveType,l.AppliedDate,l.Status FROM commanleave AS c INNER JOIN leave_details AS l ON l.CL_id=c.CL_id INNER JOIN employee AS e ON e.Empid=l.Empid WHERE l.Status=0 AND l.AppliedDate> DATE_SUB(NOW(), INTERVAL 24 HOUR) ORDER BY l.LD_Id desc";
    ...
    if($res)
  {
    ...
    while($row=mysqli_fetch_assoc($res))
    {
      $id=$row['LD_Id'];
        ...
        if($state=='0')
        {           
            $apps='<span style="color: blue">Pending <img src="loading.png"></span>';
        }
      if($x%2==1)
      {
        ...
        <tr>
          ...
          <td>'.$applied.'</td>
          <td>'.$apps.'</td>
          <td> <a href="leaveView2.php?id='.$id.'" class="btn btn-info"> View </a> </td>
        </tr> </tbody>';
      }
      else
      {
        ...
        <tr>
          ...
          <td>'.$applied.'</td>
          <td>'.$apps.'</td>
          <td> <a href="leaveView2.php?id='.$id.'" class="btn btn-primary"> View </a> </td>
        </tr> </tbody>';
      }
$x++;
    }    
