            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-lg-5">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="index.php">Abdur Rahman</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link " href="Dashboard.php">Christiya</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="">Asfara</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="">Althaf</a>
                        </li>
                    </ul>
